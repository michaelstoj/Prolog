...
% check classmates using student number
classmates(X,Y,C):-

% check classmates using student names
classmates(X,Y,C):-

%get student classes from name
studentName(X,C):-

% get teacher courses from name
teacher(X,Y):-

% A teaching assistant is a teacher who is also enrolled in some class. We want just the name.
